...
def clingo_value_to_python(value:object) -> int or str or tuple:
    ...
    if str(type(value)) == 'clingo.Symbol':
        ...
        try:
            start = len('symboltype.')
            typename = str(value.type).lower()[start:]
